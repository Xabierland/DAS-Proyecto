  ...
  \chapter{Manual de usuario}
    ...
    \cpsection{Registrarse}
      ...
      \begin{minipage}{0.4\textwidth}
        ...
        \end{figure}
      \end{minipage}
    \cpsection{Iniciar sesión}
      \begin{minipage}{0.6\textwidth}
          Para iniciar sesión en la aplicación, selecciona la opción de Iniciar sesión en el menú de navegación. A continuación, introduce tu email y contraseña y pulsa el botón de Iniciar sesión.
      \end{minipage}
      \hfill
      \begin{minipage}{0.4\textwidth}
        \begin{figure}[H]
        ...
        \end{figure}
      \end{minipage}
    \cpsection{Ver tu biblioteca}
    \cpsection{Buscar libros o usuarios}
    \cpsection{Añadir libros a tu biblioteca}
    \cpsection{Ajustes}
