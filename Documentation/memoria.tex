...
\begin{document}
  ...
  \chapter{Manual de usuario}
    ...
    \begin{multicols}{2}
        ...
        Como se observa en la Figura~\ref{fig:inicio}, la pantalla principal muestra recomendaciones de libros y un mensaje personalizado.
        ...
        La Figura~\ref{fig:menu} muestra cómo el menú lateral adapta sus opciones dependiendo del estado de autenticación.
        ...
        La Figura~\ref{fig:auth} muestra los formularios de registro e inicio de sesión, diseñados siguiendo los principios de Material Design\cite{material_design}.
        ...
        Como se muestra en la Figura~\ref{fig:notificacion}, tras completar el registro, la aplicación envía una notificación local de bienvenida.
        ...
        En la Figura~\ref{fig:perfil} se observa cómo la pantalla de perfil organiza los libros por estado de lectura y muestra las estadísticas.
        ...
        Como muestra la Figura~\ref{fig:busqueda}, es posible alternar entre búsqueda de libros y usuarios mediante un switch.
        ...
        La Figura~\ref{fig:libro} muestra cómo se visualiza la información detallada de un libro, usando fragments para separar la información de las acciones\cite{android_fragments}.
        ...
        \begin{figure}[H]
          ...
          \label{fig:libro-estados}
        \end{figure}
        
        La Figura~\ref{fig:libro-estados} muestra los diálogos para añadir un libro a la biblioteca, adaptándose al estado de lectura seleccionado.
        ...
        \begin{figure}[H]
          ...
          \label{fig:libro-leido}
        \end{figure}
        \vspace{-0.8em}  % Reduce espacio después de la figura
        
        En la Figura~\ref{fig:libro-leido} se puede observar cómo al marcar un libro como leído, aparecen campos adicionales para calificación y reseña.
        ...
        La Figura~\ref{fig:libro-land} demuestra cómo la aplicación implementa layouts específicos para orientación horizontal.
        ...
        Como se ve en la Figura~\ref{fig:ajustes}, la aplicación permite personalizar idioma y tema, además de mostrar diálogos de confirmación para acciones importantes.
    \end{multicols}   
